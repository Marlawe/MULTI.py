    ...
    while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                print(Fore.YELLOW + f"[+] THE FUCKER GIIRL MIICKY {message_index + 1} S3NT TO C0NV0 {target_id} W1TH TOK3N {token_index + 1}: {full_message} at {current_time}")
...
def main():
    ...
    print(Fore.MAGENTA + " MIICKY INSIIDE ")
    print(Fore.CYAN + "------------------------------------")
